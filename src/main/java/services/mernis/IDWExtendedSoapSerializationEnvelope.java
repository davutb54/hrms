...
public class IDWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(IDWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new IDWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static IDWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static IDWDateTimeConverter dateTimeConverter = new IDWStandardDateTimeConverter();

    public IDWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public IDWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new IDWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=IDWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,IDWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=IDWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
